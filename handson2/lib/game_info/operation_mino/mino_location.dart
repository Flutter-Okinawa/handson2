...
import 'package:handson2/game_info/enum/mino_direction.dart';
...
import 'package:handson2/game_info/enum/rotate_pattern.dart';
import 'package:handson2/game_info/operation_mino/mino_placement.dart';
...
class MinoLocation {
  ...
  void rotate(RotateDirection direction) {
    ...
    final Cordinate? shift = rotatePattern.shiftedCordinates.cast<Cordinate?>().firstWhere(
      (shift) {
        tmp = rotatedCordinates.map((c) => c += shift!).toList();
